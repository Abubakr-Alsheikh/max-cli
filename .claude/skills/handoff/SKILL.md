...
- Write LF line endings (the repo enforces `* text=auto eol=lf`).
- After writing, tell the user the path and the one line to paste into the next session: `Read .claude/handoffs/<file>.md and continue from Next Steps.`
