...
| [dashboard-first-ai-agent.md](./dashboard-first-ai-agent.md) | Draft | P1 | Roadmap: bare `max` opens the dashboard, `max <text>` goes to an AI agent. Decisions D1-D5 open |
