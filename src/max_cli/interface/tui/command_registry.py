...
COMMANDS: dict[str, dict[str, CommandSchema]] = {
    ...
    "images": {
        "compress": {
            ...
            "category": "images",
            "engine": "ImageEngine",
            "method": "compress_batch",
            "description": "Compress images in a folder",
            "has_queue_option": False,
            "fields": [
                _f("target", "path_folder", "Input Folder", required=True),
                ...
                _f("workers", "int", "Workers", default=4),
            ],
        },
        "resize": {
            "label": "Resize Images",
            ...
            "engine": "ImageEngine",
            "method": "resize_batch",
            "description": "Resize images by dimensions or scale",
            "has_queue_option": False,
            "fields": [
                _f("target", "path_folder", "Input Folder", required=True),
