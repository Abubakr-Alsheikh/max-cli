...
COMMANDS: dict[str, dict[str, CommandSchema]] = {
    ...
    "video": {
        ...
        "concat": {
            ...
            "description": "Join multiple video files together",
            "has_queue_option": False,
            "fields": [
                _f("target", "path", "Input Video", required=True),
                _f("output", "path_output", "Output Video"),
        ...
        "snap": {
            ...
            "description": "Capture screenshot at timestamp",
            "has_queue_option": False,
            "fields": [
                _f("target", "path", "Input Video", required=True),
                _f("time", "str", "Timestamp", default="00:00:05"),
        ...
        "louder": {
            ...
            "description": "Increase video audio volume",
            "has_queue_option": False,
            "fields": [
                _f("target", "path", "Input Video", required=True),
                _f("db", "float", "Gain (dB)", default=5.0),
                _f("output", "path_output", "Output Video"),
            ],
        },
        "mute": {
        ...
        "color": {
            ...
            "fields": [
                ...
                _f(
                    ...
                    "Color Preset",
                    required=True,
                    options=["vivid", "vintage", "noir", "warm", "cool", "fade"],
                ),
                _f("output", "path_output", "Output Video"),
            ],
        },
        ...
        "normalize": {
            ...
            "category": "video",
            "engine": "MediaEngine",
            "method": "normalize_audio",
            "description": "Normalize audio levels in video",
            "has_queue_option": False,
            "fields": [
                _f("target", "path", "Input Video", required=True),
                _f("level", "float", "Target Level (dB)", default=-20.0),
                _f("output", "path_output", "Output Video"),
            ],
        },
    },
